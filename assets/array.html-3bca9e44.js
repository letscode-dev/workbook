import{_ as o,r as e,o as c,c as l,f as a,a as n,b as s,d as u,e as t}from"./app-3e4ab473.js";const x={},i=n("h1",{id:"методы-работы-с-массивами",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#методы-работы-с-массивами","aria-hidden":"true"},"#"),s(" Методы работы с массивами")],-1),r=n("h3",{id:"методы",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#методы","aria-hidden":"true"},"#"),s(" Методы")],-1),k=t(`<h3 id="length-slice" tabindex="-1"><a class="header-anchor" href="#length-slice" aria-hidden="true">#</a> <code>length</code> <code>slice</code></h3><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// Длина массива (индекс последнего элемента)</span>
