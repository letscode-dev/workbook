import{_ as p,r as e,o as c,c as o,f as s,d as l,e as u,a as n,b as a}from"./app-5ffc5dde.js";const i={},x=u(`<h1 id="css-селекторы" tabindex="-1"><a class="header-anchor" href="#css-селекторы" aria-hidden="true">#</a> CSS селекторы (&gt;, +, ~)</h1><div class="language-css" data-ext="css"><pre class="language-css"><code>ul li &gt; span   <span class="token comment">/* Не все span, а только дочерние span */</span>
