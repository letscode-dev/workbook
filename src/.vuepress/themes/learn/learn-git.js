...
export const THEME_LEARN_GIT = [
	...
	},
	{
		...
		children: [
			...
			[p+'themes/pull',            'Получение данных с удаленного репозитория (fetch, pull)'],
			[p+'themes/branch',          'Работа с ветками и коммитами (branch, checkout, log, cherry-pick, stash)'],
